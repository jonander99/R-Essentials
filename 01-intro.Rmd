...
The most important packages inside the tidyverse package for this document are:  dplyr, magrittr, and ggplot.
...
The *readr* package inside the *tidyverse* family of packages has a slightly nicer read csv function you should know about.  We use the `readr::` prefix to inform readers that the `read_csv` function resides in the *readr* package.
